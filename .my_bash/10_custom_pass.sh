...
alias pe-pass='PASSWORD_STORE_DIR=~/.pe-pass pass'
...
if type _pass > /dev/null 2>&1; then
	...
	_pe_pass_completion() { PASSWORD_STORE_DIR=$HOME/.pe-pass/ _pass; }
	complete -o filenames -o nospace -F _pe_pass_completion pe-pass
fi 
