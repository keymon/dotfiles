...
prompt_setter() {
  ...
  local head_ps1="${return_color:-${green}}\\\$?=${return_code} \t${reset_color}${scm_info} rb:$(__my_rvm_ruby_version)$(virtualenv_prompt)${reset_color}${AWS_ACCOUNT_NAME:+aws:${AWS_ACCOUNT_NAME}}"
